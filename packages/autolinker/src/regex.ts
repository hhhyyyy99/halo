...
const confirmedByProtocol = `(${protocol})\\S+\\b`;
const fqdn = `(((${protocol})?(${domain}|${ipv4})(?=\\b|_)${port})|(?:${confirmedByProtocol}))`;
const phone = `(\\d{11})|(\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d)|(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d)`
...
export const urlRegex = new RegExp(`^(${url})$`, 'i');
export const fileRegex = new RegExp(`^(${file})$`, "i");
export const phoneRegex = new RegExp(`^(${phone})$`,"i")

export const chineseRegex = new RegExp(`[\u4e00-\u9fa5|\u3002|\uff1f|\uff01|\uff0c|\u3001|\uff1b|\uff1a|\u201c|\u201d|\u2018|\u2019|\uff08|\uff09|\u300a|\u300b|\u3008|\u3009|\u3010|\u3011|\u300e|\u300f|\u300c|\u300d|\ufe43|\ufe44|\u3014|\u3015|\u2026|\u2014|\uff5e|\ufe4f|\uffe5]`, 'ig');
export const textToUrlRegex = new RegExp(`(${ipv4WithPortRegex}|${ipv6WithPortRegex})|(${url})`, 'ig');
export const textToEmailRegex = new RegExp(`${email}`,'ig')
export const textToFileRegex = new RegExp(`${fileRegex}`,'ig')
export const textToPhoneRegex = new RegExp(phone,'ig')