...
const fqdn = `(((${protocol})?(${domain}|${ipv4})(?=\\b|_)${port})|(?:${confirmedByProtocol}))`;
export const url = `(${fqdn})${path}?`;
// export const ipRegex = new RegExp(`^(${ipv4}|${ipv6})$`, "ig");
// export const urlRegex = new RegExp(`^(${url})$`, "ig");
export const ipRegex = new RegExp(`\\b(${ipv4}|${ipv6})\\b`, "ig");
export const urlRegex = new RegExp(`\\b(${url})\\b`, "ig");